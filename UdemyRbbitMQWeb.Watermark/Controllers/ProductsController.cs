...
namespace UdemyRbbitMQWeb.Watermark.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(AddDbContext context, RabbitMQPublisher rabbitMQPublisher)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Products != null ?
                        ...
                        Problem("Entity set 'AddDbContext.Products'  is null.");
        }
